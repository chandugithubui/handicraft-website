...
const RazorpayPaymentForm = ({ amount, onSuccess, onError }) => {
  ...
  const handlePayment = async () => {
    try {
      ...
      const response = await fetch('https://handicraft-website.onrender.com/api/payment/create-order', {
        method: 'POST',
        headers: {
      ...
      const options = {
        ...
        handler: async function (response) {
          ...
          const verifyResponse = await fetch('https://handicraft-website.onrender.com/api/payment/verify-payment', {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json',
            },
